...
lm.f3 <- lm(baby_wt~gestation + m_ht + smoke + m_race + d_race + previous_preg + d_wt + m_wt, data = lmData )
lm.f4 <- lm(baby_wt~gestation + m_ht + smoke + m_wt + d_race + previous_preg + d_wt , data = lmData )
lm.f5 <- lm(baby_wt~gestation + m_ht + smoke + d_race + previous_preg + d_wt , data = lmData )
