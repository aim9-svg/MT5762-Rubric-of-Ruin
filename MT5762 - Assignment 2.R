...
p_wt_medu <- ggplot(babies_data,aes(m_edu,baby_wt))+
  geom_point()+
  geom_smooth(method = "lm")
...
p_wt_drace <- ggplot(babies_data,aes(d_race,baby_wt))+
  geom_point()+
  geom_smooth(method = "lm")
...
p_wt_dedu <- ggplot(babies_data,aes(d_edu,baby_wt))+
  geom_point()+
  geom_smooth(method = "lm")
...
p_wt_inc <- ggplot(babies_data,aes(income,baby_wt))+
  geom_point()+
  geom_smooth(method = "lm")
# Calculate the correlation coefficient and test whether the correlation is significant
...
p_wt_smo <- ggplot(babies_data,aes(smoke,baby_wt))+
  geom_point()+
  geom_smooth(method = "lm")

# relationship: baby weight and smoke_time
p_wt_smot <- ggplot(babies_data,aes(smoke_time,baby_wt))+
  geom_point()+
  geom_smooth(method = "lm")

# relationship: baby weight and cig_number
p_wt_cig <- ggplot(babies_data,aes(cig_number,baby_wt))+
  geom_point()+
  geom_smooth(method = "lm")
...
p_wt_marital <- ggplot(babies_data,aes(marital,baby_wt))+
  geom_point()+
  geom_smooth(method = "lm")

# Put the plots together
multiplot(p_wt_ges,p_wt_mrace,p_wt_mage,p_wt_medu,p_wt_mht,p_wt_mwt,
          p_wt_drace,p_wt_dage,p_wt_dedu,p_wt_dht,p_wt_dwt,p_wt_inc,
          p_wt_smo,p_wt_smot,p_wt_cig,p_wt_preg,p_wt_marital,cols = 4)
